...
const chainFixture: NodeInput[] = [
  ...
  node({ id: 'dept-1-1', name: 'Отдел 1.1', parentId: 'div-1', headcount: 4, budget: 400_000, performance: 60 }),
  node({ id: 'team-1-1-1', name: 'Команда 1.1.1', parentId: 'dept-1-1', headcount: 6, budget: 250_000, performance: 50 }),
]
...
const wideFixture: NodeInput[] = [
  ...chainFixture,
  node({ id: 'team-1-1-2', name: 'Команда 1.1.2', parentId: 'dept-1-1', headcount: 4, budget: 150_000, performance: 75 }),
